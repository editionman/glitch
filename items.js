...
var exports = (module.exports = {
  ...
  balls:function(ballid){
    ...
    if (ballid === 1) {
      ball={
        ballname:"Pokeball",
        ballid:1,
        ratio:1,//10% al 100%HP||19% al 90%HP||27% al 80%HP||34% al 70%HP||40% al 60%HP||45% al 50%HP||49% al 40%HP||52% al 30%HP||54% al 20%HP||55% al 10%HP||100% al 0%HP
      };
    }
    if (ballid === 2) {
      ball={
        ballname:"Superball",
        ballid:2,
        ratio:1.5,//15% al 100%HP||60% al 90%HP||70% al 80%HP||80% al 70%HP||130% al 20%HP||140% al 10%HP||150% al 0%HP
      };
    }
    if (ballid === 3) {
      ball={
  ...
  */
  ...
  changeHabilidad: function(monsterHabilidadCurrent, monsterHabilidadesEvo) {
    if (
      monsterHabilidadCurrent === monsterHabilidadesEvo[1][0] ||
      monsterHabilidadCurrent === monsterHabilidadesEvo[1][1]
    ) {
