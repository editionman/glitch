...
monsterEntity = cls.Class.extend({
  init: function(monsternum,userid) {
    ...
    this.mov_1=this.evaluateMovs.battlemoves[1]//libMonsters.monster[monsternum].movimientos[0][0];
    this.mov_2=this.evaluateMovs.battlemoves[2]//libMonsters.monster[monsternum].movimientos[0][0];
    this.mov_3=this.evaluateMovs.battlemoves[3]//libMonsters.monster[monsternum].movimientos[0][0];
    this.mov_4=this.evaluateMovs.battlemoves[4]//libMonsters.monster[monsternum].movimientos[0][0];
...
function moveObjForDB(allmoves,level,availableMoves){
  ...
  for(var i=0;i<allmoves.length;i++){
    ...
    //allmoves[i][4]--->CREADO ESPECIALMENTE PARA VER SI ESTA SIENDO USADO ESTE MOVE
