...
newobject.MonsterInfo = function(data){
  return {
    ...
    prom_ps:Utils.StatPromedio(data,"ps",libMonsters.monster[this.monster_num].stats.ps),
    prom_atk:Utils.StatPromedio(data,"atk",libMonsters.monster[this.monster_num].stats.atk),
    prom_def:Utils.StatPromedio(data,"def",libMonsters.monster[this.monster_num].stats.def),
    prom_atk_es:Utils.StatPromedio(data,"atk_es",libMonsters.monster[this.monster_num].stats.atk_es),
    prom_def_es:Utils.StatPromedio(data,"def_es",libMonsters.monster[this.monster_num].stats.def_es),
    prom_velocidad:Utils.StatPromedio(data,"velocidad",libMonsters.monster[this.monster_num].stats.velocidad),
    mov_1:data.mov_1,
    mov_2:data.mov_2,
    mov_3:data.mov_3,
    mov_4:data.mov_4,
