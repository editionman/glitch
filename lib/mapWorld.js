...
worldMap=cls.Class.extend({
  ...
  playerLeft: function(conexion,websocket){
    ...
    this.changeHostMap(player.userID);
  ...
  changeHostMap:function(oldHostID){
    var self=this;
    var founded=false;
    Object.keys(self.players).forEach(function(id){
      if(id!==oldHostID && self.players[id].host===false && founded===false){
        self.players[id].host=true;
        self.haveHost=true;
        founded=true;
      }
    });
    this.players[oldHostID].host=false;
  },
  //##############################################################################################
  //##############################################################################################
  //##############################################################################################
  //WILD MAP BATTLE FUNCTIONS
  //##############################################################################################
  //##############################################################################################
  //##############################################################################################
