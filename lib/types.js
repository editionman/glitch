...
//TIPOS POKEMON------------------------------------------------------------------------------------------------
//1-acero 2-agua 3-bicho 4-dragon 5-electrico 6-fantasma 7-fuego 8-hada 9-hielo 10-lucha
//11-normal 12-planta 13-psiquico 14-roca 15-siniestro 16-tierra 17-veneno 18-volador 19-???
//NATURALEZAS--------------------------------------------------------------------------------------------------
//1-Activa (Hasty)	2-Huraña (Lonely) 3-Afable (Mild)	4-Ingenua (Naive) 5-Agitada (Impish)
//6-Mansa (Quiet) 7-Alegre (Jolly) 8-Miedosa (Timid) 9-Alocada (Rash) 10-Modesta (Modest)
//11-Amable (Gentle) 12-Osada (Bold) 13-Audaz (Brave) 14-Pícara (Naughty) 15-Cauta (Careful)
//16-Plácida (Relaxed) 17-Dócil (Docile) 18-Rara (Quirky) 19-Firme (Adamant)	20-Serena (Calm)
//21-Floja (Lax)	22-Seria (Serious) 23-Fuerte (Hardy) 24-Tímida (Bashful) 25-Grosera (Sassy)
//GENDER--------------------------------------------------------------------------------------------------------
//0-FEMALE 1-MALE 2-NEUTRO
